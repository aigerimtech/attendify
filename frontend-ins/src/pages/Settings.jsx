...
export default function Settings() {
  ...
  const [profile, setProfile] = useState(saved_s?.profile || defaultProfile)
  ...
  return (
    <div className="fade-in">
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={handleSave} className={`btn-primary transition-all ${saved ? 'bg-emerald-600 hover:bg-emerald-600' : ''}`}>
        ...
        <Section title="Security" icon={Shield}>
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800/50">
              <div>
                <p className="text-sm font-semibold text-slate-700 dark:text-slate-200">Two-Factor Authentication</p>
